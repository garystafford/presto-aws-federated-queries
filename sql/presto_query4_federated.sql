...
WITH cross_sales AS (
    ...
    FROM
        ...
        hive.default.customer_demographics cd1,
        hive.default.customer_demographics cd2,
        promotion,
        household_demographics hd1,
        household_demographics hd2,
        rds_postgresql.public.customer_address ad1,
        rds_postgresql.public.customer_address ad2,
        income_band ib1,
        income_band ib2
    WHERE
